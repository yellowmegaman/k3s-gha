...
docker run -d --name=k3s --privileged --tmpfs /run --tmpfs /var/run -p 6443:6443 -p 80:80 -v "$PWD"/k3s.yaml:/etc/rancher/k3s/k3s.yaml --mount 'type=bind,src=/home/yellowmegaman/za2dp.sh,dst=/eba.sh'
